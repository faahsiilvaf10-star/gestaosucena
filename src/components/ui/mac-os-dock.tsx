...
export const MacOSDock: React.FC<MacOSDockProps> = ({ 
  ...
  const getResponsiveConfig = useCallback(() => {
    ...
    if (smallerDimension < 480) {
      ...
      return {
        baseIconSize: 48, // Ajustado para não ficar gigante na navbar
        maxScale: 1.6,
        effectWidth: 240
      };
    }
      ...
      >
        {apps.map((app, index) => {
          ...
          return (
            ...
            >
              <div 
                className="w-full h-full flex items-center justify-center rounded-2xl bg-gradient-to-b from-white/10 to-transparent border border-white/10 shadow-xl transition-colors duration-200"
                style={{
